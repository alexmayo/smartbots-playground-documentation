...
These examples demonstrate how to start and continue conversations with the built-in AI in the Bot Playground.

## Example 1: Starting and Continuing a Conversation

This example starts a new conversation with the AI using an asynchronous function.
...
This example shows how to continue an existing conversation by linking messages together using `parentMessageId`.
